...
@section('content')
    ...
    <div id="controller">
        <div class="row">
            <div class="col-md-5 offset-md-3">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" autocomplate="off" placeholder="Search from title" v-model="search">
                </div>
            </div>
             <div class="col-md-2">
        ...
        <div class="modal-dialog">
          ...
          <form method="post" :action="editStatus ? actionUrl+'/'+book.id : actionUrl" autocomplete="off">
    ...
    methods: {
        ...
        deleteData(id){
            if (confirm("Are you sure to delete this book?")) {
                const _this = this;
                axios.delete(actionUrl + '/' + id)
                    .then(function(response) {
                        // Delete book from books array
                        _this.books = _this.books.filter(function(book) {
                            return book.id !== id;
                        });
