...
<body>
	...
	<form action="edit.php?isbn=<?php echo $isbn; ?>" method="post">
		<table width="25%" border="0">
          ...
          echo '<option ' .
              ($penerbit_data['id_penerbit'] == $id_penerbit
                  ? 'selected'
                  : '') .
              " value='" .
          ...
          echo '<option ' .
              ($pengarang_data['id_pengarang'] == $id_pengarang
                  ? 'selected'
                  : '') .
              " value='" .
          ...
          echo '<option ' .
              ($katalog_data['id_katalog'] == $id_katalog ? 'selected' : '') .
              " value='" .
              $katalog_data['id_katalog'] .
              "'>" .
              $katalog_data['nama'] .
              '</option>';
      } ?>
	...
	<?php if (isset($_POST['update'])) {
     ...
     $result = mysqli_query(
         $mysqli,
         "UPDATE buku SET judul = '$judul', tahun = '$tahun', id_penerbit = '$id_penerbit', id_pengarang = '$id_pengarang', id_katalog = '$id_katalog', qty_stok = '$qty_stok', harga_pinjam = '$harga_pinjam' WHERE isbn = '$isbn';"
     );
